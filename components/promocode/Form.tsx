...
export const PromocodeForm = ({
  ...
  const form = useForm<Omit<IPromocode, "id">>();
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 text-black">
        ...
        <div className="flex items-center space-x-2">
          ...
          <Label htmlFor="is_limited">
            Promokodni ma&apos;lum miqdor oralig&apos;ida cheklash
          </Label>
        </div>
        {is_limited && (
          <div className="flex items-center space-x-2">
        ...
        {is_limited && (
          <div className="space-y-2">
            ...
            <Input
              ...
              {...register("min_amount", {
                required: is_limited
                  ? "Minimal miqdorni kiritish shart"
                  : false,
              })}
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              {...register("max_amount", {
                required:
                  is_limited && is_max_limited
                    ? "Maksimal miqdorni kiritish shart"
                    : false,
              })}
